...
```
cd existing_repo
git remote add origin https://bender.sheridanc.on.ca/sikkemha/variety-shoe-json-data-on-a-webpage.git
git branch -M main
...
- [ ] [Set up project integrations](https://bender.sheridanc.on.ca/sikkemha/variety-shoe-json-data-on-a-webpage/-/settings/integrations)
